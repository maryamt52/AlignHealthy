                ...
                <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{ textAlign: 'left', color: 'var(--color-text-muted)', lineHeight: '1.8' }}>
                        <p style={{ marginBottom: '1.5rem' }}>
                            With Align Health Method, we help you train with purpose, improve your fitness over time, and build nutrition habits that support energy, performance, and long-term health — without hype, without clinical claims, and without promising overnight results.
                        </p>
                        <p style={{ marginBottom: '1.5rem' }}>
